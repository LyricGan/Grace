...
public class WrapperAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    private static class RefreshHeaderContainerViewHolder extends RecyclerView.ViewHolder {
    ...
    private static class LoadMoreFooterContainerViewHolder extends RecyclerView.ViewHolder {
