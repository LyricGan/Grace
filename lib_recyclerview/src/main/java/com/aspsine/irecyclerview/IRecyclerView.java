...
public class IRecyclerView extends RecyclerView {
    ...
    public IRecyclerView(Context context, @Nullable AttributeSet attrs, int defStyle) {
        ...
        final TypedArray array = context.obtainStyledAttributes(attrs, R.styleable.IRecyclerView, defStyle, 0);
        ...
        try {
            refreshEnabled = array.getBoolean(R.styleable.IRecyclerView_refreshEnabled, false);
            loadMoreEnabled = array.getBoolean(R.styleable.IRecyclerView_loadMoreEnabled, false);
            refreshHeaderLayoutRes = array.getResourceId(R.styleable.IRecyclerView_refreshHeaderLayout, -1);
            loadMoreFooterLayoutRes = array.getResourceId(R.styleable.IRecyclerView_loadMoreFooterLayout, -1);
            refreshFinalMoveOffset = array.getDimensionPixelOffset(R.styleable.IRecyclerView_refreshFinalMoveOffset, -1);
        } finally {
            array.recycle();
        }
    ...
    OnLoadMoreScrollListener mOnLoadMoreScrollListener = new OnLoadMoreScrollListener() {
        @Override
