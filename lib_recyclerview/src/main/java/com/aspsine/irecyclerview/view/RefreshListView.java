...
public class RefreshListView extends FrameLayout {
    ...
    public boolean isShowContent() {
        return (View.VISIBLE == getRecyclerView().getVisibility());
    }

    public void showScrollBars(boolean flag) {
        RecyclerView recyclerView = getRecyclerView();
        recyclerView.setScrollbarFadingEnabled(flag);
        recyclerView.setVerticalScrollBarEnabled(flag);
    }
}
