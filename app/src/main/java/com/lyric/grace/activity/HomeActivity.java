...
public class HomeActivity extends BaseCompatActivity {
    private static final Class<?>[] ACTIVITY = {MainActivity.class, CircleProgressBarActivity.class, CollapsibleTestActivity.class, LoadingActivity.class, SpannableTestActivity.class, SwipeMenuActivity.class, SwipeMenuSimpleActivity.class, ViewTestActivity.class, WebActivity.class};
    private static final String[] TITLE = {"MainActivity", "CircleProgressBarActivity", "CollapsibleTestActivity", "LoadingActivity", "SpannableTestActivity", "SwipeMenuActivity", "SwipeMenuSimpleActivity", "ViewTestActivity", "WebActivity"};
    ...
    private void initialize() {
        ...
        adapter.setOnItemClickListener(new BaseRecyclerAdapter.OnItemClickListener<HomeItemEntity>() {
            ...
            public void onItemClick(int position, HomeItemEntity item, View view) {
                ActivityUtils.toActivity(HomeActivity.this, (Class<? extends Activity>) item.getClazz());
            }
        });
