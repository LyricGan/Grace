package com.lyricgan.grace.commonui;
 ...
 * @since 2019-12-07
 */
public class GraceWebView extends WebView {
    ...
    private static class WebChromeClientDelegate extends WebChromeClient {
        ...
        public boolean onJsPrompt(WebView view, String url, String message, String defaultValue, JsPromptResult result) {
            if (view instanceof GraceWebView) {
                if (((GraceWebView) view).handleJsInterface(view, url, message, defaultValue, result)) {
                    return true;
                }
            }
        ...
        private void injectJavascriptInterfaces(WebView view) {
            if (view instanceof GraceWebView) {
                ((GraceWebView) view).injectJavascriptInterfaces();
            }
        }
    }
