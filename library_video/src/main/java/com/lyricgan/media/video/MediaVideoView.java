...
import com.lyricgan.media.video.util.ScreenResolution;

public class MediaVideoView extends SurfaceView implements MediaPlayerControl, IPowerStateListener {
    private Uri mUri;
    ...
    public void setVideoLayout(int layout) {
        ...
        if (mVideoHeight > 0 && mVideoWidth > 0) {
            ...
            if (layout == MediaVideoView.MOVIE_RATIO_MODE_16_9) {// 16:9
                ...
                lp.width = (int) dw;
                lp.height = (int) dh;
            } else if (layout == MediaVideoView.MOVIE_RATIO_MODE_4_3) {// 4:3
            ...
            } else if (layout == MediaVideoView.MOVIE_RATIO_MODE_ORIGIN &&
                    mSurfaceWidth < windowWidth && mSurfaceHeight < windowHeight) {
                lp.width = (int) (mSurfaceHeight * videoRatio);
                lp.height = mSurfaceHeight;
            } else if (layout == MediaVideoView.MOVIE_RATIO_MODE_FULLSCREEN) {
    ...
    OnPreparedListener mPreparedListener = new OnPreparedListener() {
        ...
        public void onPrepared(MediaPlayer mp) {
            ...
            mVideoWidth = mp.getVideoWidth();
            mVideoHeight = mp.getVideoHeight();
            setVideoLayout(MediaVideoView.MOVIE_RATIO_MODE_DEFAULT);
    ...
    public void release(final boolean clearTargetState) {
        ...
        if (Constants.DEBUG) {
            Log.e(Constants.LOG_TAG, "MediaVideoView release cost :" + String.valueOf(System.currentTimeMillis() - current));
        }
    }
