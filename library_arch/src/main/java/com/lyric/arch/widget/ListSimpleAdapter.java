 ...
 * @author lyricgan
 */
public abstract class ListSimpleAdapter<T> extends BaseAdapter {
    ...
    public ListSimpleAdapter(Context context, T[] arrays) {
        this(context, Arrays.asList(arrays));
    }

    public ListSimpleAdapter(Context context, List<T> itemList) {
